"use strict";
(self["webpackChunkmosaic_docs"] = self["webpackChunkmosaic_docs"] || []).push([["node_modules_ptsecurity_mosaic-examples_fesm2020_ptsecurity-mosaic-examples-mosaic-splitter_mjs"],{

/***/ 67841:
/*!*************************************************************!*\
  !*** ./dist/mosaic/fesm2020/ptsecurity-mosaic-splitter.mjs ***!
  \*************************************************************/
...
/* harmony export */   "McGutterDirective": () => (/* binding */ McGutterDirective),
/* harmony export */   "McGutterGhostDirective": () => (/* binding */ McGutterGhostDirective),
/* harmony export */   "McSplitterAreaDirective": () => (/* binding */ McSplitterAreaDirective),
/* harmony export */   "McSplitterComponent": () => (/* binding */ McSplitterComponent),
/* harmony export */   "McSplitterModule": () => (/* binding */ McSplitterModule)
/* harmony export */ });
...
function McSplitterComponent_ng_template_1_mc_gutter_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mc-gutter", 3);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("mousedown", function McSplitterComponent_ng_template_1_mc_gutter_0_Template_mc_gutter_mousedown_0_listener($event) {
      ...
      return ctx_r6.onMouseDown($event, index_r3, index_r3 + 1);
    });
  ...
  if (rf & 2) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵstyleProp"]("display", ctx_r5.hideGutters ? "none" : "flex");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("direction", ctx_r5.direction)("size", ctx_r5.gutterSize)("order", index_r3 * 2 + 1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵattribute"]("disabled", ctx_r5.disabled || null);
  }
}

function McSplitterComponent_ng_template_1_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](0, McSplitterComponent_ng_template_1_mc_gutter_0_Template, 1, 6, "mc-gutter", 2);
  }

  if (rf & 2) {
    const last_r4 = ctx.last;
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngIf", last_r4 === false);
  }
}

function McSplitterComponent_mc_gutter_ghost_2_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "mc-gutter-ghost");
  }
}
...
class McGutterGhostDirective {
  ...
  set x(x) {
    ...
    this.setStyle("left"
    /* Left */
    , (0,_angular_cdk_coercion__WEBPACK_IMPORTED_MODULE_1__.coerceCssPixelValue)(x));
  }
  ...
  set y(y) {
    ...
    this.setStyle("top"
    /* Top */
    , (0,_angular_cdk_coercion__WEBPACK_IMPORTED_MODULE_1__.coerceCssPixelValue)(y));
  }
  ...
  updateDimensions() {
    this.setStyle(this.isVertical ? "width"
    /* Width */
    : "height"
    /* Height */
    , '100%');
...
McGutterGhostDirective.ɵfac = function McGutterGhostDirective_Factory(t) {
  return new (t || McGutterGhostDirective)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_0__.ElementRef), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_0__.Renderer2));
};
/** @nocollapse */
...
McGutterGhostDirective.ɵdir = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineDirective"]({
  type: McGutterGhostDirective,
  selectors: [["mc-gutter-ghost"]],
  hostAttrs: [1, "mc-gutter-ghost"],
  hostVars: 4,
  hostBindings: function McGutterGhostDirective_HostBindings(rf, ctx) {
    if (rf & 2) {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵclassProp"]("mc-gutter-ghost_vertical", ctx.isVertical)("mc-gutter-ghost_visible", ctx.visible);
    }
  },
  inputs: {
    visible: "visible",
...
(function () {
  (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](McGutterGhostDirective, [{
    type: _angular_core__WEBPACK_IMPORTED_MODULE_0__.Directive,
    args: [{
...
class McSplitterComponent {
  constructor(elementRef, changeDetectorRef, ngZone, renderer) {
    ...
    this.ngZone = ngZone;
    this.renderer = renderer;
    this.gutterPositionChange = new _angular_core__WEBPACK_IMPORTED_MODULE_0__.EventEmitter();
    this.areas = [];
  ...
  set useGhost(useGhost) {
    this._useGhost = (0,_angular_cdk_coercion__WEBPACK_IMPORTED_MODULE_1__.coerceBooleanProperty)(useGhost);
  }
  ...
  onMouseUp(leftArea, rightArea, currentGutter) {
    ...
    if (this.useGhost && currentGutter) {
      const gutterPosition = currentGutter.getPosition();
      const offset = this.ghost.direction === Direction.Vertical ? gutterPosition.y - this.ghost.y : gutterPosition.x - this.ghost.x;
      this.resizeAreas(leftArea, rightArea, offset);
...
McSplitterComponent.ɵcmp = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
  ...
  viewQuery: function McSplitterComponent_Query(rf, ctx) {
    if (rf & 1) {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵviewQuery"](McGutterGhostDirective, 5);
    ...
    if (rf & 2) {
      ...
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵqueryRefresh"](_t = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵloadQuery"]()) && (ctx.ghost = _t.first);
  ...
  outputs: {
    gutterPositionChange: "gutterPositionChange"
  },
  exportAs: ["mcSplitter"],
  ngContentSelectors: _c0,
  decls: 3,
  vars: 2,
  consts: [["ngFor", "", 3, "ngForOf"], [4, "ngIf"], [3, "direction", "display", "size", "order", "mousedown", 4, "ngIf"], [3, "direction", "size", "order", "mousedown"]],
  template: function McSplitterComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](2, McSplitterComponent_mc_gutter_ghost_2_Template, 1, 0, "mc-gutter-ghost", 1);
    }
    ...
    if (rf & 2) {
      ...
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngIf", ctx.useGhost);
    }
  },
  directives: [_angular_common__WEBPACK_IMPORTED_MODULE_2__.NgForOf, _angular_common__WEBPACK_IMPORTED_MODULE_2__.NgIf, McGutterDirective, McGutterGhostDirective],
...
class McSplitterAreaDirective {
  ...
  setSize(size) {
    ...
    this.setStyle(this.getSizeProperty(), (0,_angular_cdk_coercion__WEBPACK_IMPORTED_MODULE_1__.coerceCssPixelValue)((0,_angular_cdk_coercion__WEBPACK_IMPORTED_MODULE_1__.coerceNumberProperty)(size)));
  }
...
McSplitterAreaDirective.ɵdir = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineDirective"]({
  ...
  hostVars: 2,
  hostBindings: function McSplitterAreaDirective_HostBindings(rf, ctx) {
    if (rf & 2) {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵclassProp"]("mc-splitter-area_resizing", ctx.isResizing());
    }
  },
  outputs: {
...
(function () {
  (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](McSplitterModule, [{
    ...
    args: [{
      ...
      declarations: [McGutterDirective, McGutterGhostDirective, McSplitterAreaDirective, McSplitterComponent]
    }]
  }], null, null);
})();
/**
...
/***/ 15013:
/*!**********************************************************************************************************!*\
  !*** ./node_modules/@ptsecurity/mosaic-examples/fesm2020/ptsecurity-mosaic-examples-mosaic-splitter.mjs ***!
  \**********************************************************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "SplitterExamplesModule": () => (/* binding */ SplitterExamplesModule),
/* harmony export */   "SplitterFixedExample": () => (/* binding */ SplitterFixedExample),
/* harmony export */   "SplitterNestedExample": () => (/* binding */ SplitterNestedExample),
/* harmony export */   "SplitterOverviewExample": () => (/* binding */ SplitterOverviewExample),
/* harmony export */   "SplitterVerticalExample": () => (/* binding */ SplitterVerticalExample)
/* harmony export */ });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ 22560);
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/forms */ 2508);
/* harmony import */ var _ptsecurity_mosaic_splitter__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @ptsecurity/mosaic/splitter */ 67841);
...
SplitterFixedExample.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: SplitterFixedExample, selectors: [["splitter-fixed-example"]], decls: 7, vars: 0, consts: [["mc-splitter-area", "", 1, "mc-splitter-area_fixed-width"], ["mc-splitter-area", "", 1, "flex"], ["mc-splitter-area", ""]], template: function SplitterFixedExample_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mc-splitter")(1, "div", 0);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]()();
    } }, directives: [_ptsecurity_mosaic_splitter__WEBPACK_IMPORTED_MODULE_1__.McSplitterComponent, _ptsecurity_mosaic_splitter__WEBPACK_IMPORTED_MODULE_1__.McSplitterAreaDirective], styles: ["mc-splitter[_ngcontent-%COMP%]{display:flex;border:1px solid black;height:100px;margin:2px}.mc-splitter-area_fixed-width[_ngcontent-%COMP%]{min-width:200px}div[mc-splitter-area][_ngcontent-%COMP%]{background:#c5c0c0}"] });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SplitterFixedExample, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__.Component,
        args: [{ selector: 'splitter-fixed-example', template: "<mc-splitter>\n    <div mc-splitter-area class=\"mc-splitter-area_fixed-width\">first (with min-width)</div>\n    <div mc-splitter-area class=\"flex\">second</div>\n    <div mc-splitter-area>third</div>\n</mc-splitter>\n", styles: ["mc-splitter{display:flex;border:1px solid black;height:100px;margin:2px}.mc-splitter-area_fixed-width{min-width:200px}div[mc-splitter-area]{background:#c5c0c0}\n"] }]
    }], null, null); })();
...
class SplitterNestedExample {
    constructor() {
        this.direction = _ptsecurity_mosaic_splitter__WEBPACK_IMPORTED_MODULE_1__.Direction;
    }
}
SplitterNestedExample.ɵfac = function SplitterNestedExample_Factory(t) { return new (t || SplitterNestedExample)(); };
SplitterNestedExample.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: SplitterNestedExample, selectors: [["splitter-nested-example"]], decls: 19, vars: 1, consts: [[1, "with-border"], ["mc-splitter-area", ""], ["mc-splitter-area", "", 1, "flex"], [1, "without-border", "flex", 3, "direction"], ["mc-splitter-area", "", 1, "layout-column", "flex"], [1, "flex", "nested-splitter"]], template: function SplitterNestedExample_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mc-splitter", 0)(1, "div", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](2, "left");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](3, "div", 2)(4, "mc-splitter", 3)(5, "div", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](6, "top");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](7, "div", 4)(8, "mc-splitter", 5)(9, "div", 1);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("direction", ctx.direction.Vertical);
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SplitterNestedExample, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__.Component,
        args: [{ selector: 'splitter-nested-example', template: "<mc-splitter class=\"with-border\">\n    <div mc-splitter-area>left</div>\n    <div mc-splitter-area class=\"flex\">\n        <mc-splitter class=\"without-border flex\" [direction]=\"direction.Vertical\">\n            <div mc-splitter-area>top</div>\n            <div mc-splitter-area class=\"layout-column flex\">\n                <mc-splitter class=\"flex nested-splitter\">\n                    <div mc-splitter-area>center-left</div>\n                    <div mc-splitter-area class=\"flex\">center</div>\n                    <div mc-splitter-area>center-right</div>\n                </mc-splitter>\n            </div>\n            <div mc-splitter-area>bottom</div>\n        </mc-splitter>\n    </div>\n    <div mc-splitter-area>right</div>\n</mc-splitter>\n", styles: ["mc-splitter.with-border{border:1px solid black;height:300px;margin:2px}mc-splitter.without-border{height:300px}.with-border>div[mc-splitter-area]{background:#c5c0c0}.without-border>div[mc-splitter-area]{background:#b3b3b3}.nested-splitter>div[mc-splitter-area]{background:#9f9f9f}\n"] }]
    }], null, null); })();
...
SplitterOverviewExample.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: SplitterOverviewExample, selectors: [["splitter-overview-example"]], decls: 7, vars: 0, consts: [["mc-splitter-area", ""], ["mc-splitter-area", "", 1, "flex"]], template: function SplitterOverviewExample_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mc-splitter")(1, "div", 0);
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SplitterOverviewExample, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__.Component,
        args: [{ selector: 'splitter-overview-example', template: "<mc-splitter>\n    <div mc-splitter-area>first</div>\n    <div mc-splitter-area class=\"flex\">second</div>\n    <div mc-splitter-area>third</div>\n</mc-splitter>\n", styles: ["mc-splitter{border:1px solid black;height:100px;margin:2px}div[mc-splitter-area]{background:#c5c0c0}\n"] }]
    }], null, null); })();
...
SplitterVerticalExample.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: SplitterVerticalExample, selectors: [["splitter-vertical-example"]], decls: 7, vars: 1, consts: [[3, "direction"], ["mc-splitter-area", "", 1, "mc-splitter-area_fixed-height"], ["mc-splitter-area", "", 1, "flex"], ["mc-splitter-area", ""]], template: function SplitterVerticalExample_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mc-splitter", 0)(1, "div", 1);
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SplitterVerticalExample, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__.Component,
        args: [{ selector: 'splitter-vertical-example', template: "<mc-splitter [direction]=\"direction.Vertical\">\n    <div mc-splitter-area class=\"mc-splitter-area_fixed-height\">first (with min-height)</div>\n    <div mc-splitter-area class=\"flex\">second</div>\n    <div mc-splitter-area>third</div>\n</mc-splitter>\n", styles: ["mc-splitter{display:flex;border:1px solid black;height:400px;margin:2px}.mc-splitter-area_fixed-height{min-height:100px}div[mc-splitter-area]{background:#c5c0c0}\n"] }]
    }], null, null); })();
...
SplitterExamplesModule.ɵmod = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({ type: SplitterExamplesModule });
SplitterExamplesModule.ɵinj = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ imports: [[
            _angular_forms__WEBPACK_IMPORTED_MODULE_2__.FormsModule,
            _ptsecurity_mosaic_splitter__WEBPACK_IMPORTED_MODULE_1__.McSplitterModule
        ]] });
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](SplitterExamplesModule, { declarations: [SplitterOverviewExample,
        SplitterFixedExample,
        SplitterVerticalExample,
        SplitterNestedExample], imports: [_angular_forms__WEBPACK_IMPORTED_MODULE_2__.FormsModule,
        _ptsecurity_mosaic_splitter__WEBPACK_IMPORTED_MODULE_1__.McSplitterModule], exports: [SplitterOverviewExample,
        SplitterFixedExample,
        SplitterVerticalExample,
        SplitterNestedExample] }); })();
...
//# sourceMappingURL=node_modules_ptsecurity_mosaic-examples_fesm2020_ptsecurity-mosaic-examples-mosaic-splitter_mjs.js.map