...
/* harmony export */   "MC_SIDEPANEL_DATA": function() { return /* binding */ MC_SIDEPANEL_DATA; },
/* harmony export */   "MC_SIDEPANEL_DEFAULT_OPTIONS": function() { return /* binding */ MC_SIDEPANEL_DEFAULT_OPTIONS; },
/* harmony export */   "MC_SIDEPANEL_WITH_INDENT": function() { return /* binding */ MC_SIDEPANEL_WITH_INDENT; },
/* harmony export */   "MC_SIDEPANEL_WITH_SHADOW": function() { return /* binding */ MC_SIDEPANEL_WITH_SHADOW; },
/* harmony export */   "McSidepanelActions": function() { return /* binding */ McSidepanelActions; },
/* harmony export */   "McSidepanelBody": function() { return /* binding */ McSidepanelBody; },
/* harmony export */   "McSidepanelClose": function() { return /* binding */ McSidepanelClose; },
/* harmony export */   "McSidepanelConfig": function() { return /* binding */ McSidepanelConfig; },
/* harmony export */   "McSidepanelContainerComponent": function() { return /* binding */ McSidepanelContainerComponent; },
/* harmony export */   "McSidepanelFooter": function() { return /* binding */ McSidepanelFooter; },
/* harmony export */   "McSidepanelHeader": function() { return /* binding */ McSidepanelHeader; },
/* harmony export */   "McSidepanelModule": function() { return /* binding */ McSidepanelModule; },
/* harmony export */   "McSidepanelPosition": function() { return /* binding */ McSidepanelPosition; },
/* harmony export */   "McSidepanelRef": function() { return /* binding */ McSidepanelRef; },
/* harmony export */   "McSidepanelService": function() { return /* binding */ McSidepanelService; }
/* harmony export */ });
...
/* harmony import */ var _ptsecurity_mosaic_icon__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @ptsecurity/mosaic/icon */ 86463);
/* harmony import */ var _ptsecurity_mosaic_button__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @ptsecurity/mosaic/button */ 80623);
...
class McSidepanelRef {
  constructor(containerInstance, overlayRef, config) {
    ...
    containerInstance.animationStateChanged.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.filter)(event => event.phaseName === 'done' && event.toState === McSidepanelAnimationState.Visible), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.take)(1)).subscribe(() => {
      this.afterOpened$.next();
      this.afterOpened$.complete();
    }); // Dispose overlay when closing animation is complete

    containerInstance.animationStateChanged.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.filter)(event => event.phaseName === 'done' && event.toState === McSidepanelAnimationState.Hidden), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.take)(1)).subscribe(() => {
      overlayRef.dispose();
    ...
    if (!containerInstance.sidepanelConfig.disableClose) {
      ...
      (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.filter)(event => event.keyCode === _ptsecurity_cdk_keycodes__WEBPACK_IMPORTED_MODULE_7__.ESCAPE))).subscribe(() => this.close());
    }
  }
  ...
  close(result) {
    if (!this.afterClosed$.closed) {
      ...
      this.containerInstance.animationStateChanged.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.filter)(event => event.phaseName === 'done'), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.take)(1)).subscribe(() => this.overlayRef.detachBackdrop());
      this.result = result;
...
class McSidepanelContainerComponent extends _angular_cdk_portal__WEBPACK_IMPORTED_MODULE_8__.BasePortalOutlet {
...
McSidepanelContainerComponent.ɵcmp = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
  ...
  decls: 4,
  vars: 1,
  consts: [[1, "mc-sidepanel-wrapper"], ["class", "mc-sidepanel-indent", 3, "click", 4, "ngIf"], ["cdkTrapFocus", "", 1, "mc-sidepanel-content"], ["cdkPortalOutlet", ""], [1, "mc-sidepanel-indent", 3, "click"]],
...
class McSidepanelService {
  ...
  open(componentOrTemplateRef, config) {
    ...
    if (componentOrTemplateRef instanceof _angular_core__WEBPACK_IMPORTED_MODULE_0__.TemplateRef) {
      ...
      const portal = new _angular_cdk_portal__WEBPACK_IMPORTED_MODULE_8__.ComponentPortal(componentOrTemplateRef, undefined, injector);
  ...
  attachContainer(overlayRef, config) {
    const openedSidepanelsWithSamePosition = this.getOpenedSidepanelsWithSamePosition(config); // tslint:disable-next-line:deprecation

    const injector = new _angular_cdk_portal__WEBPACK_IMPORTED_MODULE_8__.PortalInjector(this.injector, new WeakMap([[McSidepanelConfig, config], [MC_SIDEPANEL_WITH_INDENT, openedSidepanelsWithSamePosition.length >= 1], [MC_SIDEPANEL_WITH_SHADOW, openedSidepanelsWithSamePosition.length < 2] // tslint:disable-line
    ]));
    const containerPortal = new _angular_cdk_portal__WEBPACK_IMPORTED_MODULE_8__.ComponentPortal(McSidepanelContainerComponent, undefined, injector);
  ...
  createInjector(config, sidepanelRef, // tslint:disable-next-line:deprecation
  sidepanelContainer) {
    ...
    const injectionTokens = new WeakMap([[McSidepanelContainerComponent, sidepanelContainer], [MC_SIDEPANEL_DATA, config.data], [McSidepanelRef, sidepanelRef]]); // tslint:disable-next-line:deprecation
...
McSidepanelClose.ɵdir = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineDirective"]({
...
class McSidepanelHeader {
  ngAfterContentInit() {
    ...
    (_a = this.autoFocusedElement) === null || _a === void 0 ? void 0 : _a.nativeElement.focus();
  }
...
McSidepanelHeader.ɵcmp = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
  type: McSidepanelHeader,
  selectors: [["mc-sidepanel-header"]],
  contentQueries: function McSidepanelHeader_ContentQueries(rf, ctx, dirIndex) {
    if (rf & 1) {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵcontentQuery"](dirIndex, _c1, 5, _angular_core__WEBPACK_IMPORTED_MODULE_0__.ElementRef);
    }

    if (rf & 2) {
      let _t;

      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵqueryRefresh"](_t = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵloadQuery"]()) && (ctx.autoFocusedElement = _t.first);
    }
  },
  ...
  directives: [_angular_common__WEBPACK_IMPORTED_MODULE_9__.NgIf, McSidepanelClose, _ptsecurity_mosaic_icon__WEBPACK_IMPORTED_MODULE_12__.McIcon, _ptsecurity_mosaic_icon__WEBPACK_IMPORTED_MODULE_12__.McIconCSSStyler],
  encapsulation: 2
});
...
McSidepanelBody.ɵdir = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineDirective"]({
  type: McSidepanelBody,
  selectors: [["mc-sidepanel-body"], ["", "mc-sidepanel-body", ""], ["mcSidepanelBody"]],
  contentQueries: function McSidepanelBody_ContentQueries(rf, ctx, dirIndex) {
    if (rf & 1) {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵcontentQuery"](dirIndex, _c1, 5, _angular_core__WEBPACK_IMPORTED_MODULE_0__.ElementRef);
    }
...
McSidepanelFooter.ɵdir = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineDirective"]({
  type: McSidepanelFooter,
  selectors: [["mc-sidepanel-footer"], ["", "mc-sidepanel-footer", ""], ["mcSidepanelFooter"]],
  contentQueries: function McSidepanelFooter_ContentQueries(rf, ctx, dirIndex) {
    if (rf & 1) {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵcontentQuery"](dirIndex, _c1, 5, _angular_core__WEBPACK_IMPORTED_MODULE_0__.ElementRef);
    }
...
McSidepanelActions.ɵdir = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineDirective"]({
...
McSidepanelModule.ɵmod = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
  type: McSidepanelModule
});
/** @nocollapse */

McSidepanelModule.ɵinj = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "SidepanelComponentExample": function() { return /* binding */ SidepanelComponentExample; },
/* harmony export */   "SidepanelExampleCustomComponent": function() { return /* binding */ SidepanelExampleCustomComponent; },
/* harmony export */   "SidepanelExamplesModule": function() { return /* binding */ SidepanelExamplesModule; },
/* harmony export */   "SidepanelOverviewExample": function() { return /* binding */ SidepanelOverviewExample; }
/* harmony export */ });
...
/* harmony import */ var _ptsecurity_mosaic_icon__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @ptsecurity/mosaic/icon */ 86463);
...
/* harmony import */ var _ptsecurity_mosaic_sidepanel__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @ptsecurity/mosaic/sidepanel */ 39911);
/* harmony import */ var _ptsecurity_mosaic_toggle__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @ptsecurity/mosaic/toggle */ 84031);
...
SidepanelComponentExample.ɵfac = function SidepanelComponentExample_Factory(t) { return new (t || SidepanelComponentExample)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_ptsecurity_mosaic_sidepanel__WEBPACK_IMPORTED_MODULE_1__.McSidepanelService)); };
SidepanelComponentExample.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: SidepanelComponentExample, selectors: [["sidepanel-component-example"]], decls: 22, vars: 4, consts: [[1, "mc-form-horizontal", "margin"], [1, "mc-form__row"], [1, "mc-form__label"], [1, "mc-form__control", "flex-10"], [3, "value", "valueChange"], ["value", "right"], ["value", "left"], ["value", "top"], ["value", "bottom"], [1, "layout-row", "mc-form__control", "layout-align-center-center", "flex-10"], [3, "ngModel", "ngModelChange"], ["mc-button", "", 3, "color", "click"]], template: function SidepanelComponentExample_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("valueChange", function SidepanelComponentExample_Template_mc_select_valueChange_5_listener($event) { return ctx.position = $event; });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function SidepanelComponentExample_Template_mc_toggle_ngModelChange_15_listener($event) { return ctx.modalState = $event; });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function SidepanelComponentExample_Template_button_click_19_listener() { return ctx.openComponentSidepanel(); });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SidepanelComponentExample, [{
    ...
    }], function () { return [{ type: _ptsecurity_mosaic_sidepanel__WEBPACK_IMPORTED_MODULE_1__.McSidepanelService }]; }, null); })();
...
SidepanelExampleCustomComponent.ɵfac = function SidepanelExampleCustomComponent_Factory(t) { return new (t || SidepanelExampleCustomComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_ptsecurity_mosaic_sidepanel__WEBPACK_IMPORTED_MODULE_1__.MC_SIDEPANEL_DATA)); };
SidepanelExampleCustomComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: SidepanelExampleCustomComponent, selectors: [["example-sidepanel"]], hostAttrs: [1, "layout-column", "flex", "sidepanel-container"], decls: 14, vars: 4, consts: [[3, "closeable"], [1, "layout-padding"], [1, "mc-subheading"], [4, "ngFor", "ngForOf"], ["align", "right"], ["mc-button", "", 3, "color", "click"], ["mc-button", "", "mc-sidepanel-close", "", 3, "color"]], template: function SidepanelExampleCustomComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function SidepanelExampleCustomComponent_Template_button_click_8_listener() { return ctx.openComponentSidepanel(); });
...
function SidepanelOverviewExample_ng_template_22_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function SidepanelOverviewExample_ng_template_22_Template_button_click_8_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r5); const ctx_r4 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r4.openTemplateSidepanel(); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](9, "span");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](10, "Open another sidepanel");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function SidepanelOverviewExample_ng_template_22_Template_button_click_12_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r5); const ctx_r6 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r6.openTemplateSidepanel(); });
...
SidepanelOverviewExample.ɵfac = function SidepanelOverviewExample_Factory(t) { return new (t || SidepanelOverviewExample)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_ptsecurity_mosaic_sidepanel__WEBPACK_IMPORTED_MODULE_1__.McSidepanelService)); };
SidepanelOverviewExample.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: SidepanelOverviewExample, selectors: [["sidepanel-overview-example"]], viewQuery: function SidepanelOverviewExample_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, decls: 23, vars: 4, consts: [[1, "mc-form-horizontal", "margin"], [1, "mc-form__row"], [1, "mc-form__label"], [1, "mc-form__control", "flex-10"], [3, "value", "valueChange"], ["value", "right"], ["value", "left"], ["value", "top"], ["value", "bottom"], [1, "layout-row", "mc-form__control", "layout-align-center-center", "flex-10"], [3, "ngModel", "ngModelChange"], ["mc-button", "", 1, "template-button", 3, "color", "click"], [3, "closeable"], [1, "layout-padding"], [1, "mc-subheading"], [4, "ngFor", "ngForOf"], ["align", "left"], ["mc-button", "", 3, "color", "click"], ["align", "right"], ["mc-button", "", "mc-sidepanel-close", "", 3, "color"]], template: function SidepanelOverviewExample_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "div", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](2, "label", 2);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](3, "Position");
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](4, "mc-form-field", 3);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](5, "mc-select", 4);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("valueChange", function SidepanelOverviewExample_Template_mc_select_valueChange_5_listener($event) { return ctx.position = $event; });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](6, "mc-option", 5);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](7, "Right");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](8, "mc-option", 6);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](14, "div", 9);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](15, "mc-toggle", 10);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function SidepanelOverviewExample_Template_mc_toggle_ngModelChange_15_listener($event) { return ctx.modalState = $event; });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](16);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](18, "br");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](19, "button", 11);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function SidepanelOverviewExample_Template_button_click_19_listener() { return ctx.openTemplateSidepanel(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](20, "span");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](21, "Open template sidepanel");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](22, SidepanelOverviewExample_ng_template_22_Template, 18, 5, "ng-template");
    } if (rf & 2) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](5);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("value", ctx.position);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](10);
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SidepanelOverviewExample, [{
    ...
    }], function () { return [{ type: _ptsecurity_mosaic_sidepanel__WEBPACK_IMPORTED_MODULE_1__.McSidepanelService }]; }, { template: [{
            type: _angular_core__WEBPACK_IMPORTED_MODULE_0__.ViewChild,
...
SidepanelExamplesModule.ɵmod = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({ type: SidepanelExamplesModule });
SidepanelExamplesModule.ɵinj = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ imports: [[
            ...
            _ptsecurity_mosaic_sidepanel__WEBPACK_IMPORTED_MODULE_1__.McSidepanelModule,
            ...
            _ptsecurity_mosaic_toggle__WEBPACK_IMPORTED_MODULE_5__.McToggleModule,
            _angular_forms__WEBPACK_IMPORTED_MODULE_6__.FormsModule
        ]] });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SidepanelExamplesModule, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__.NgModule,
        args: [{
                imports: [
                    _angular_common__WEBPACK_IMPORTED_MODULE_8__.CommonModule,
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](SidepanelExamplesModule, { declarations: [SidepanelOverviewExample,
        SidepanelComponentExample,
        SidepanelExampleCustomComponent], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_8__.CommonModule,
        _ptsecurity_mosaic_button__WEBPACK_IMPORTED_MODULE_7__.McButtonModule,
        _ptsecurity_mosaic_icon__WEBPACK_IMPORTED_MODULE_9__.McIconModule,
        _ptsecurity_mosaic_sidepanel__WEBPACK_IMPORTED_MODULE_1__.McSidepanelModule,
        _ptsecurity_mosaic_form_field__WEBPACK_IMPORTED_MODULE_2__.McFormFieldModule,
        _ptsecurity_mosaic_select__WEBPACK_IMPORTED_MODULE_3__.McSelectModule,
        _ptsecurity_mosaic_toggle__WEBPACK_IMPORTED_MODULE_5__.McToggleModule,
        _angular_forms__WEBPACK_IMPORTED_MODULE_6__.FormsModule], exports: [SidepanelOverviewExample,
        SidepanelComponentExample,
        SidepanelExampleCustomComponent] }); })();
...
//# sourceMappingURL=node_modules_ptsecurity_mosaic-examples_fesm2015_ptsecurity-mosaic-examples-mosaic-sidepanel_js-es2015.js.map