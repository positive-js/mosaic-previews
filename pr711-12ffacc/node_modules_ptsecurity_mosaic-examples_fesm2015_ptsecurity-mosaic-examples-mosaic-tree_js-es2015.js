...
TreeActionButtonExample.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: TreeActionButtonExample, selectors: [["tree-action-button-example"]], decls: 11, vars: 4, consts: [[3, "ngModel", "dataSource", "treeControl", "ngModelChange", "onSelectAll", "onCopy"], ["mcTreeNodePadding", "", 3, "disabled", 4, "mcTreeNodeDef"], ["mcTreeNodePadding", "", 4, "mcTreeNodeDef", "mcTreeNodeDefWhen"], ["dropdown", ""], ["mc-dropdown-item", ""], ["mcTreeNodePadding", "", 3, "disabled"], [3, "innerHTML"], ["mcTooltip", "Tooltip text", 3, "mcPlacement", "mcDropdownTriggerFor"], ["mcTreeNodePadding", ""], [3, "node"]], template: function TreeActionButtonExample_Template(rf, ctx) { if (rf & 1) {
