  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([[13], {
    ...
    function hvHG(module, __webpack_exports__, __webpack_require__) {
      ...
      McPopoverComponent.ɵfac = function McPopoverComponent_Factory(t) {
        return new (t || McPopoverComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_3__["ChangeDetectorRef"]), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_3__["ElementRef"]));
      };
      ...
      McPopoverComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({
        ...
        hostBindings: function McPopoverComponent_HostBindings(rf, ctx) {
          if (rf & 1) {
            _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("keydown", function McPopoverComponent_keydown_HostBindingHandler($event) {
        ...
        decls: 6,
        vars: 8,
        consts: [[1, "mc-popover", 3, "ngClass"], [1, "mc-popover__container"], ["class", "mc-popover__header", 4, "ngIf"], ["class", "mc-popover__content", 4, "ngIf"], ["class", "mc-popover__footer", 4, "ngIf"], [1, "mc-popover__arrow", 3, "ngClass"], [1, "mc-popover__header"], [3, "ngTemplateOutlet", 4, "ngIf"], [4, "ngIf"], [3, "ngTemplateOutlet"], [3, "innerHTML"], [1, "mc-popover__content"], [1, "mc-popover__footer"]],
      ...
      * */
        ...
        _createClass(McPopover, [{
          ...
          value: function createOverlay() {
            ...
            strategy.positionChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["takeUntil"])(this.destroyed)).subscribe(function (change) {
              if (_this2.popover) {
                ...
                if (change.scrollableViewProperties.isOverlayClipped && _this2.popover.mcVisible) {
          ...
          value: function show() {
            ...
            if (!this.popover) {
              ...
              this.popover.afterHidden().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["takeUntil"])(this.destroyed)).subscribe(function () {
              ...
              this.popover.mcVisibleChange.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["takeUntil"])(this.$unsubscribe), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["distinctUntilChanged"])()).subscribe(function (data) {
                _this8.mcVisible = data;

                _this8.mcVisibleChange.emit(data);

                _this8.isPopoverOpen = data;
              });
            }
      ...
      McPopover.ɵdir = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineDirective"]({
        ...
        inputs: {
          ...
          mcHeader: ["mcPopoverHeader", "mcHeader"],
          mcContent: ["mcPopoverContent", "mcContent"],
          mcFooter: ["mcPopoverFooter", "mcFooter"],
          disabled: ["mcPopoverDisabled", "disabled"],
          mcMouseEnterDelay: ["mcPopoverMouseEnterDelay", "mcMouseEnterDelay"],
          mcMouseLeaveDelay: ["mcPopoverMouseLeaveDelay", "mcMouseLeaveDelay"],
          mcTrigger: ["mcPopoverTrigger", "mcTrigger"],
          mcPopoverSize: "mcPopoverSize",
          mcPlacementPriority: ["mcPopoverPlacementPriority", "mcPlacementPriority"],
          mcPlacement: ["mcPopoverPlacement", "mcPlacement"],
          classList: ["mcPopoverClass", "classList"],
          mcVisible: ["mcPopoverVisible", "mcVisible"]
        },
        outputs: {
          mcVisibleChange: "mcPopoverVisibleChange",
