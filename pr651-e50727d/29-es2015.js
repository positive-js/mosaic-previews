...
/* harmony import */ var _ptsecurity_mosaic_radio__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @ptsecurity/mosaic/radio */ "BRpl");
...
LayoutFlexBehaviourModifiersExample.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: LayoutFlexBehaviourModifiersExample, selectors: [["layout-flex-behaviour-modifiers-example"]], decls: 25, vars: 4, consts: [[1, "example-controls"], [3, "ngModel", "ngModelChange"], ["value", "flex"], ["value", "flex-none"], ["value", "flex-auto"], ["value", "flex-grow"], ["value", "flex-nogrow"], ["value", "flex-noshrink"], [1, "layout-row", "block"], [1, "flex", "block"], [1, "flex-none", "block"]], template: function LayoutFlexBehaviourModifiersExample_Template(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: [_ptsecurity_mosaic_radio__WEBPACK_IMPORTED_MODULE_5__["McRadioGroup"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["NgControlStatus"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["NgModel"], _ptsecurity_mosaic_radio__WEBPACK_IMPORTED_MODULE_5__["McRadioButton"]], styles: [".example-controls[_ngcontent-%COMP%]{display:flex;flex-direction:row}.block[_ngcontent-%COMP%]{border:1px solid #000;padding:8px}.mc-radio-group[_ngcontent-%COMP%]{display:flex;flex-direction:column}.mc-radio-button[_ngcontent-%COMP%]{margin-bottom:8px}"] });
...
LayoutFlexOrderExample.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: LayoutFlexOrderExample, selectors: [["layout-flex-order-example"]], decls: 30, vars: 15, consts: [[1, "example-controls"], [1, "layout-column", "flex"], [1, "layout-padding"], [3, "value", "valueChange"], [3, "value", 4, "ngFor", "ngForOf"], [1, "layout-row", "block"], [3, "value"]], template: function LayoutFlexOrderExample_Template(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: [_ptsecurity_mosaic_form_field__WEBPACK_IMPORTED_MODULE_3__["McFormField"], _ptsecurity_mosaic_select__WEBPACK_IMPORTED_MODULE_6__["McSelect"], _angular_common__WEBPACK_IMPORTED_MODULE_7__["NgForOf"], _ptsecurity_mosaic_core__WEBPACK_IMPORTED_MODULE_8__["McOption"]], styles: [".example-controls[_ngcontent-%COMP%]{display:flex;flex-direction:row}.mc-form-field[_ngcontent-%COMP%]{max-width:50%}.block[_ngcontent-%COMP%]{border:1px solid #000;padding:8px}.mc-radio-group[_ngcontent-%COMP%]{display:flex;flex-direction:column}.mc-radio-button[_ngcontent-%COMP%]{margin-bottom:8px}"] });
