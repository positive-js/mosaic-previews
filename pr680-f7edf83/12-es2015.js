...
class McPopoverComponent {
    ...
    updateClassMap(size, placement, popoverClass) {
        this.classMap = {
            [`mc-popover_placement-${_ptsecurity_mosaic_core__WEBPACK_IMPORTED_MODULE_8__["POSITION_TO_CSS_MAP"][placement]}`]: true,
...
McPopoverComponent.ɵfac = function McPopoverComponent_Factory(t) { return new (t || McPopoverComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_3__["ChangeDetectorRef"])); };
McPopoverComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({ type: McPopoverComponent, selectors: [["mc-popover"]], decls: 6, vars: 8, consts: [[1, "mc-popover", 3, "ngClass"], [1, "mc-popover__container"], ["class", "mc-popover__header", 4, "ngIf"], ["class", "mc-popover__content", 4, "ngIf"], ["class", "mc-popover__footer", 4, "ngIf"], [1, "mc-popover__arrow", 3, "ngClass"], [1, "mc-popover__header"], [3, "ngTemplateOutlet", 4, "ngIf"], [4, "ngIf"], [3, "ngTemplateOutlet"], [1, "mc-popover__content"], [1, "mc-popover__footer"]], template: function McPopoverComponent_Template(rf, ctx) { if (rf & 1) {
...
class McPopover {
    ...
    closingActions() {
        ...
        const outsidePointerEvents = this.hasBackdrop ? rxjs__WEBPACK_IMPORTED_MODULE_9__["NEVER"] : this.overlayRef.outsidePointerEvents();
...
McPopover.ɵdir = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineDirective"]({ type: McPopover, selectors: [["", "mcPopover", ""]], hostVars: 2, hostBindings: function McPopover_HostBindings(rf, ctx) { if (rf & 1) {
    ...
    } }, inputs: { backdropClass: "backdropClass", hasBackdrop: "hasBackdrop", header: ["mcPopoverHeader", "header"], content: ["mcPopoverContent", "content"], footer: ["mcPopoverFooter", "footer"], disabled: ["mcPopoverDisabled", "disabled"], trigger: ["mcPopoverTrigger", "trigger"], size: ["mcPopoverSize", "size"], mcPlacementPriority: ["mcPopoverPlacementPriority", "mcPlacementPriority"], placement: ["mcPopoverPlacement", "placement"], popoverClass: ["mcPopoverClass", "popoverClass"], visible: ["mcPopoverVisible", "visible"], enterDelay: ["mcPopoverEnterDelay", "enterDelay"], leaveDelay: ["mcPopoverLeaveDelay", "leaveDelay"] }, outputs: { mcVisibleChange: "mcPopoverVisibleChange", mcPositionStrategyPlacementChange: "mcPopoverPositionStrategyPlacementChange" }, exportAs: ["mcPopover"] });
/** @nocollapse */
...
McPopover.propDecorators = {
    ...
    enterDelay: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"], args: ['mcPopoverEnterDelay',] }],
    leaveDelay: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"], args: ['mcPopoverLeaveDelay',] }],
    ...
    header: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"], args: ['mcPopoverHeader',] }],
    content: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"], args: ['mcPopoverContent',] }],
    footer: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"], args: ['mcPopoverFooter',] }],
    disabled: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"], args: ['mcPopoverDisabled',] }],
    trigger: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"], args: ['mcPopoverTrigger',] }],
    size: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"], args: ['mcPopoverSize',] }],
    mcPlacementPriority: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"], args: ['mcPopoverPlacementPriority',] }],
    placement: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"], args: ['mcPopoverPlacement',] }],
    popoverClass: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"], args: ['mcPopoverClass',] }],
    visible: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"], args: ['mcPopoverVisible',] }]
};
