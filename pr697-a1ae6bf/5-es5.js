(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([[5], {
    ...
    function F9T(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "MAX_YEAR", function () {
        return MAX_YEAR;
      });
      /* harmony export (binding) */
      ...
      var McDatepickerInput = /*#__PURE__*/function () {
        ...
        _createClass(McDatepickerInput, [{
          ...
          value: function isKeyForByPass(event) {
            // tslint:disable-next-line: deprecation
            return Object(_ptsecurity_cdk_keycodes__WEBPACK_IMPORTED_MODULE_11__["hasModifierKey"])(event) && (Object(_ptsecurity_cdk_keycodes__WEBPACK_IMPORTED_MODULE_11__["isVerticalMovement"])(event.keyCode) || Object(_ptsecurity_cdk_keycodes__WEBPACK_IMPORTED_MODULE_11__["isHorizontalMovement"])(event.keyCode)) || event.ctrlKey || event.metaKey;
          }
        }, {
          key: "spaceKeyHandler",
          ...
          value: function getDigitPositions(format) {
            ...
            formatInLowerCase.split('').reduce(function (_ref, value, index, arr) {
              var prev = _ref.prev,
                  length = _ref.length,
                  start = _ref.start;
      ...
      var DatepickerLanguageExample = /*#__PURE__*/function () {
        ...
        _createClass(DatepickerLanguageExample, [{
          ...
          value: function setFormat($event) {
            ...
            this.selectedLanguage = this.languageList.find(function (_ref2) {
              var name = _ref2.name;
