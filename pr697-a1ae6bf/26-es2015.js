...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DropdownNavigationWrapExample", function() { return DropdownNavigationWrapExample; });
...
/* harmony import */ var _ptsecurity_mosaic_checkbox__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ptsecurity/mosaic/checkbox */ "LyUW");
 ...
 */
class DropdownNavigationWrapExample {
}
DropdownNavigationWrapExample.ɵfac = function DropdownNavigationWrapExample_Factory(t) { return new (t || DropdownNavigationWrapExample)(); };
DropdownNavigationWrapExample.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: DropdownNavigationWrapExample, selectors: [["dropdown-navigation-wrap-example"]], decls: 41, vars: 4, consts: [["mc-button", "", 3, "mcDropdownTriggerFor"], ["mc-icon", "mc-angle-down-L_16"], [3, "navigationWithWrap"], ["appDropdown", "mcDropdown"], ["mc-dropdown-item", ""], ["mc-icon", "mc-info-o_16"], [1, "mc-dropdown-item__caption"], ["mc-icon", "mc-circle-8_16"], [1, "mc-dropdown__divider"], [1, "mc-dropdown__group-header"], ["mc-dropdown-item", "", "disabled", ""], [1, "mc-dropdown__group-header", "mc-dropdown__group-header_small"]], template: function DropdownNavigationWrapExample_Template(rf, ctx) { if (rf & 1) {
...
DropdownNestedExample.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: DropdownNestedExample, selectors: [["dropdown-nested-example"]], decls: 68, vars: 24, consts: [["mc-button", "", 3, "mcDropdownTriggerFor"], ["mc-icon", "mc-angle-down-L_16"], ["appDropdownWithNested", "mcDropdown"], ["mc-dropdown-item", ""], ["mc-dropdown-item", "", 3, "mcDropdownTriggerFor"], ["mc-dropdown-item", "", 3, "disabled", "mcDropdownTriggerFor"], [1, "mc-dropdown__divider"], ["appDropdownNested", "mcDropdown"], ["appDropdownNestedNested", "mcDropdown"]], template: function DropdownNestedExample_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "button", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](1, " dropdown ");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](2, "i", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
...
function DropdownOverviewExample_ng_template_61_Template(rf, ctx) { if (rf & 1) {
...
DropdownOverviewExample.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: DropdownOverviewExample, selectors: [["dropdown-overview-example"]], decls: 62, vars: 13, consts: [[3, "checked", "change"], ["mc-button", "", 3, "mcDropdownTriggerFor", "openByArrowDown", "disabled"], ["mc-icon", "mc-angle-down-L_16"], ["appDropdown", "mcDropdown"], ["mc-dropdown-item", ""], ["mc-icon", "mc-info-o_16"], [1, "mc-dropdown-item__caption"], ["mc-icon", "mc-circle-8_16"], [1, "mc-dropdown__divider"], [1, "mc-dropdown__group-header"], ["mc-dropdown-item", "", "disabled", ""], [1, "mc-dropdown__group-header", "mc-dropdown__group-header_small"], [1, "max-width"], ["mcInput", "", "type", "text", 3, "ngModel", "ngModelChange"], ["mc-button", "", 3, "mcDropdownTriggerFor", "mcDropdownTriggerData", "disabled"], ["appDropdownLazy", "mcDropdown"], ["mcDropdownContent", ""], ["mc-dropdown-item", "", 3, "disabled"]], template: function DropdownOverviewExample_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ngModelChange", function DropdownOverviewExample_Template_input_ngModelChange_53_listener($event) { return ctx.someValue = $event; });
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](DropdownExamplesModule, { declarations: [DropdownNestedExample,
        DropdownOverviewExample,
        DropdownNavigationWrapExample], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"],
        _ptsecurity_mosaic_button__WEBPACK_IMPORTED_MODULE_3__["McButtonModule"],
        _ptsecurity_mosaic_checkbox__WEBPACK_IMPORTED_MODULE_4__["McCheckboxModule"],
        _ptsecurity_mosaic_dropdown__WEBPACK_IMPORTED_MODULE_5__["McDropdownModule"],
