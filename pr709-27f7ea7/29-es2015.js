...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "InputExamplesModule", function() { return InputExamplesModule; });
...
/* harmony import */ var _ptsecurity_mosaic_form_field__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @ptsecurity/mosaic/form-field */ "20Zt");
...
InputNumberOverviewExample.ɵfac = function InputNumberOverviewExample_Factory(t) { return new (t || InputNumberOverviewExample)(); };
InputNumberOverviewExample.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: InputNumberOverviewExample, selectors: [["input-number-overview-example"]], decls: 3, vars: 2, consts: [[1, "mc-group-item"], ["mcInput", "", "type", "number", "placeholder", "Allowed number from -7 to 7", "max", "7", "step", "0.5", "big-step", "1.5", 3, "ngModel", "min", "ngModelChange"]], template: function InputNumberOverviewExample_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mc-form-field", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "input", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function InputNumberOverviewExample_Template_input_ngModelChange_1_listener($event) { return ctx.value = $event; });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](InputNumberOverviewExample, [{
...
InputOverviewExample.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: InputOverviewExample, selectors: [["input-overview-example"]], decls: 11, vars: 4, consts: [["mcPrefix", "", "mc-icon", "mc-search_16", 3, "color"], ["mcInput", "", "placeholder", "Placeholder", 3, "ngModel", "ngModelChange"], ["mcFormFieldWithoutBorders", ""]], template: function InputOverviewExample_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function InputOverviewExample_Template_input_ngModelChange_2_listener($event) { return ctx.value = $event; });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function InputOverviewExample_Template_input_ngModelChange_9_listener($event) { return ctx.value = $event; });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
InputExamplesModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({ type: InputExamplesModule });
InputExamplesModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ imports: [[
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](InputExamplesModule, { declarations: [InputOverviewExample,
        InputNumberOverviewExample], imports: [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormsModule"],
        _ptsecurity_mosaic_form_field__WEBPACK_IMPORTED_MODULE_2__["McFormFieldModule"],
        _ptsecurity_mosaic_icon__WEBPACK_IMPORTED_MODULE_3__["McIconModule"],
        _ptsecurity_mosaic_input__WEBPACK_IMPORTED_MODULE_4__["McInputModule"]], exports: [InputOverviewExample,
        InputNumberOverviewExample] }); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](InputExamplesModule, [{
