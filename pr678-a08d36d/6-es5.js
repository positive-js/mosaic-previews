        ...
        _createClass(McDatepicker, [{
          ...
          value: function registerInput(input) {
            ...
            this.inputSubscription = this.datepickerInput.valueChange.subscribe(function (value) {
              ...
              _this8.selected = value; // @ts-ignore

              if (_this8.popupComponentRef) {
                (_a = _this8.popupComponentRef.instance.calendar.monthView) === null || _a === void 0 ? void 0 : _a.init();
                _this8.popupComponentRef.instance.calendar.activeDate = value;
              }
            });
          }
          /** Open the calendar. */
          ...
          value: function openAsPopup() {
            ...
            if (!this.popupRef.hasAttached()) {
              ...
              this.ngZone.onStable.asObservable().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["take"])(1)).subscribe(function () {
                return _this10.popupRef.updatePosition();
              });
            }
          }
          /** Create the popup. */
          ...
          value: function createPopup() {
            ...
            this.closeSubscription = this.closingActions().subscribe(function () {
              return _this11.close(_this11.restoreFocus());
            });
          }
        }, {
          key: "restoreFocus",
      ...
      var McDatepickerInput = /*#__PURE__*/function () {
        function McDatepickerInput(elementRef, renderer, dateAdapter, dateFormats) {
          ...
          this.onInput = function () {
            _this12.correctCursorPosition();

            var formattedValue = _this12.replaceSymbols(_this12.viewValue);

            var newTimeObj = _this12.getDateFromString(formattedValue);

            _this12.lastValueValid = !!newTimeObj;

            if (!newTimeObj) {
              _this12.control.updateValueAndValidity();

              _this12._value = null;
              return;
            }

            _this12.setViewValue(_this12.getTimeStringFromDate(newTimeObj, _this12.dateFormats.dateInput), true);

            _this12.selectNextDigitByCursor(_this12.selectionStart);

            _this12.updateValue(newTimeObj);
          };

          this.parseOnBlur = function () {
            if (!_this12.viewValue) {
              return null;
            }

            var date = _this12.getDefaultValue();

            var viewDigits = _this12.viewValue.split(_this12.separator).map(function (value) {
              return value;
            ...
            if (viewDigits.length !== 3) {
              _this12.lastValueValid = false;
              _this12._value = null;
              return setTimeout(function () {
                return _this12.control.updateValueAndValidity();
              });
            }

            date[_this12.firstDigit.fullName] = _this12.firstDigit.parse(firsViewDigit);
            date[_this12.secondDigit.fullName] = _this12.secondDigit.parse(secondViewDigit);
            date[_this12.thirdDigit.fullName] = _this12.thirdDigit.parse(thirdViewDigit);

            var _reduce = [_this12.firstDigit, _this12.secondDigit, _this12.thirdDigit].reduce(function (acc, digit, index) {
            ...
            var newTimeObj = _this12.getValidDateOrNull(_this12.dateAdapter.createDateTime(date.year, date.month, date.date, date.hours, date.minutes, date.seconds, date.milliseconds));
          ...
          this.updateLocaleParams = function () {
            _this12.setFormat(_this12.dateFormats.dateInput);

            _this12.value = _this12.value;
          };
          ...
          this.parseValidator = function () {
            return _this12.focused || _this12.empty || _this12.lastValueValid ? null : {
              mcDatepickerParse: {
                text: _this12.elementRef.nativeElement.value
              }
            };
          };
          ...
          this.minValidator = function (control) {
            var controlValue = _this12.getValidDateOrNull(_this12.dateAdapter.deserialize(control.value));

            return !_this12.min || !controlValue || _this12.dateAdapter.compareDate(_this12.min, controlValue) <= 0 ? null : {
              mcDatepickerMin: {
                min: _this12.min,
                actual: controlValue
              }
          ...
          this.maxValidator = function (control) {
            ...
            return !_this12.max || !controlValue || _this12.dateAdapter.compareDate(_this12.max, controlValue) >= 0 ? null : {
              mcDatepickerMax: {
                max: _this12.max,
                actual: controlValue
              }
          ...
          this.filterValidator = function (control) {
            ...
            return !_this12.dateFilter || !controlValue || _this12.dateFilter(controlValue) ? null : {
        ...
        _createClass(McDatepickerInput, [{
          ...
          set: function set(value) {
            ...
            this.datepickerSubscription = this.datepicker.selectedChanged.subscribe(function (selected) {
              ...
              _this13.cvaOnChange(selected);

              _this13.onTouched();

              _this13.dateChange.emit(new McDatepickerInputEvent(_this13, _this13.elementRef.nativeElement));
            });
          }
          ...
          value: function setFormat(format) {
            ...
            this.separatorPositions = format.split('').reduce(function (acc, item, index) {
              return _this14.separator === item ? [].concat(_toConsumableArray(acc), [index + 1]) : acc;
            }, []);
          ...
          value: function selectNextDigitByCursor(cursorPos) {
            ...
            setTimeout(function () {
              var _this16$getDateEditMe = _this16.getDateEditMetrics(cursorPos),
                  _this16$getDateEditMe2 = _slicedToArray(_this16$getDateEditMe, 3),
                  endPositionOfCurrentDigit = _this16$getDateEditMe2[2];

              var _this16$getDateEditMe3 = _this16.getDateEditMetrics(endPositionOfCurrentDigit + 1),
                  _this16$getDateEditMe4 = _slicedToArray(_this16$getDateEditMe3, 3),
                  selectionStart = _this16$getDateEditMe4[1],
                  selectionEnd = _this16$getDateEditMe4[2];
          ...
          value: function selectNextDigit(cursorPos) {
            ...
            setTimeout(function () {
              ...
              var nextSeparatorPos = _this17.viewValue.indexOf(_this17.separator, cursorPos);

              var newCursorPos = nextSeparatorPos > 0 ? nextSeparatorPos + 1 : lastValue;

              var _this17$getDateEditMe = _this17.getDateEditMetrics(newCursorPos),
                  _this17$getDateEditMe2 = _slicedToArray(_this17$getDateEditMe, 3),
                  selectionStart = _this17$getDateEditMe2[1],
                  selectionEnd = _this17$getDateEditMe2[2];

              _this17.selectionStart = selectionStart;
              _this17.selectionEnd = selectionEnd;
            });
          }
          ...
          value: function getDigitPositions(format) {
            ...
            formatInLowerCase.split('').reduce(function (_ref2, value, index, arr) {
              ...
              if (value === _this18.separator || arr.length - 1 === index) {
                if (!_this18.firstDigit) {
                  _this18.firstDigit = new DateDigit(prev, start, length, _this18.dateAdapter.firstMonth);
                } else if (!_this18.secondDigit) {
                  _this18.secondDigit = new DateDigit(prev, start, length, _this18.dateAdapter.firstMonth);
                } else if (!_this18.thirdDigit) {
                  _this18.thirdDigit = new DateDigit(prev, start, arr.length - start, _this18.dateAdapter.firstMonth);
                } // tslint:disable:no-parameter-reassignment
        ...
        _createClass(McDatepickerToggle, [{
          ...
          value: function watchStateChanges() {
            ...
            this.stateChanges = Object(rxjs__WEBPACK_IMPORTED_MODULE_9__["merge"])(this.intl.changes, datepickerDisabled, inputDisabled, datepickerToggled).subscribe(function () {
              return _this19.changeDetectorRef.markForCheck();
            });
          }
        }]);
