...
/* harmony import */ var _ptsecurity_mosaic_link__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @ptsecurity/mosaic/link */ "DI8n");
...
DropdownNestedExample.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: DropdownNestedExample, selectors: [["dropdown-nested-example"]], decls: 20, vars: 2, consts: [["mc-button", "", 3, "mcDropdownTriggerFor"], ["mc-icon", "mc-angle-down-L_16"], ["appDropdownNested", "mcDropdown"], ["mc-dropdown-item", "", 3, "mcDropdownTriggerFor"], ["mc-dropdown-item", ""], [1, "mc-dropdown__item-caption"], ["appDropdown", "mcDropdown"], ["mc-icon", "mc-search_16"]], template: function DropdownNestedExample_Template(rf, ctx) { if (rf & 1) {
...
function DropdownOverviewExample_ng_template_39_Template(rf, ctx) { if (rf & 1) {
...
DropdownOverviewExample.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: DropdownOverviewExample, selectors: [["dropdown-overview-example"]], decls: 42, vars: 12, consts: [[1, "example-dropdown-group"], [1, "mc-group", "example-dropdown-element"], ["mc-button", "", 1, "mc-group-item", 3, "disabled"], ["mc-button", "", 1, "mc-group-item", 3, "mcDropdownTriggerFor", "disabled"], ["mc-icon", "mc-angle-down-L_16"], [1, "example-dropdown-element"], ["mc-button", "", 1, "example-dropdown-element", 3, "mcDropdownTriggerFor", "disabled"], ["appDropdown", "mcDropdown"], ["mc-dropdown-item", "", 1, "mc-selected"], [1, "mc-dropdown__item-caption"], ["mc-dropdown-item", ""], ["mc-icon", "mc-search_16"], ["mc-dropdown-item", "", "disabled", ""], ["href", "https://google.com", "mc-link", "", "mc-dropdown-item", ""], [1, "mc-link__text"], ["mcInput", "", "type", "text", 3, "ngModel", "ngModelChange"], ["mc-button", "", 3, "mcDropdownTriggerFor", "mcDropdownTriggerData", "disabled"], ["appDropdownLazy", "mcDropdown"], ["mcDropdownContent", ""], [1, "example-dropdown-element", 3, "checked", "change"], ["mc-dropdown-item", "", 3, "disabled"]], template: function DropdownOverviewExample_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ngModelChange", function DropdownOverviewExample_Template_input_ngModelChange_32_listener($event) { return ctx.someValue = $event; });
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("change", function DropdownOverviewExample_Template_mc_checkbox_change_40_listener() { return ctx.toggleDisabled(); });
...
DropdownExamplesModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({ imports: [[
            ...
            _ptsecurity_mosaic_link__WEBPACK_IMPORTED_MODULE_7__["McLinkModule"]
        ]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](DropdownExamplesModule, { declarations: [DropdownNestedExample,
        ...
        _ptsecurity_mosaic_dropdown__WEBPACK_IMPORTED_MODULE_5__["McDropdownModule"],
        _ptsecurity_mosaic_icon__WEBPACK_IMPORTED_MODULE_6__["McIconModule"],
        _ptsecurity_mosaic_link__WEBPACK_IMPORTED_MODULE_7__["McLinkModule"]], exports: [DropdownNestedExample,
        DropdownOverviewExample] }); })();
