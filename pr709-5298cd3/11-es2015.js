...
McListOption.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({ type: McListOption, selectors: [["mc-list-option"]], contentQueries: function McListOption_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("focusin", function McListOption_focusin_HostBindingHandler() { return ctx.focus(); })("blur", function McListOption_blur_HostBindingHandler() { return ctx.blur(); })("click", function McListOption_click_HostBindingHandler($event) { return ctx.handleClick($event); });
    } if (rf & 2) {
...
McListSelection.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({ type: McListSelection, selectors: [["mc-list-selection"]], contentQueries: function McListSelection_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("keydown", function McListSelection_keydown_HostBindingHandler($event) { return ctx.onKeyDown($event); })("resize", function McListSelection_resize_HostBindingHandler() { return ctx.updateScrollSize(); }, false, _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵresolveWindow"]);
    } if (rf & 2) {
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵattribute"]("tabindex", -1)("disabled", ctx.disabled || null);
    } }, inputs: { disabled: "disabled", horizontal: "horizontal", compareWith: "compareWith", autoSelect: "autoSelect", noUnselectLast: "noUnselectLast", tabIndex: "tabIndex" }, outputs: { selectionChange: "selectionChange" }, exportAs: ["mcListSelection"], features: [_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵProvidersFeature"]([MC_SELECTION_LIST_VALUE_ACCESSOR]), _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵInheritDefinitionFeature"]], ngContentSelectors: _c1, decls: 2, vars: 1, consts: [[3, "focus", "blur"]], template: function McListSelection_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵprojectionDef"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("focus", function McListSelection_Template_div_focus_0_listener() { return ctx.focus(); })("blur", function McListSelection_Template_div_blur_0_listener() { return ctx.blur(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵprojection"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
    } if (rf & 2) {
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵattribute"]("tabindex", ctx.tabIndex);
